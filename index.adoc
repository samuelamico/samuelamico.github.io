...
.Biel image
image::biel.png[Biel,300,300,role="left",align="center"]

.Negative image
image::negativebiel.png[Negative,300,300,role="right",align="center"] 
...
.Biel image
image::biel.png[Biel,200,200,float="right"]

.Swapping image
image::bielmix.png[Swapping,200,200,float="left"] 
